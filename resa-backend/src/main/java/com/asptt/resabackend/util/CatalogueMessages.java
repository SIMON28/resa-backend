...
public interface CatalogueMessages {
    ...
    //Problème adherent null
    public final String ADHERENT_NULL = "adherent.null";
    /**
     * AccueilPage
     */
    ...
    public final String DESINSCRIPTION_CONFIRMATION_VR = "confirmation.vr.info.plongeur";
    ...
    /**
     * ConfirmSuppPalanquePanel 
     */
    //Confirmation de la suppression de l'adherent
    public final String PALANQUE_CONFIRME_SUPP = "confirme.supp";
    /**
     * SaisieFSConfValidFSPanel 
     */
    //Confirmation de la suppression de l'adherent
    public final String FS_CONFIRME_VALID = "confirme.valid";
    /**
     * ConfSuppFSPanel 
     */
    //Confirmation de la suppression de l'adherent
    public final String FS_CONFIRME_SUPP = "confirme.supp";
    /**
     ...
     */
    //message de haut de page
    public final String SAISIE_DATE_CREATION_FS_ADMIN = "msgCreationFSAdmin";
    public final String SAISIE_DATE_CONSULT_FS_ADMIN = "msgConsultFSAdmin";
    public final String SAISIE_DATE_CONSULT_FS_ADH = "msgConsultFSAdh";
}
