package com.asptt.resabackend.commons.resource;
 ...
 * @param <T>
 */
public abstract class ResourceBaseResa<T extends Object> implements Resource<T> {

	private static final org.slf4j.Logger LOGGER = LoggerFactory
			.getLogger(ResourceBaseResa.class);
	...
	public Response updateWithNotNull(final UriInfo uriInfo, final String id,
		...
		try {
			...
			ResourceBaseResa.LOGGER.error("Can't update resource properties", ex);
