...
import com.asptt.resa.commons.utils.BeanUtils;
...
public class Jackson {
	...
	public static <R> ObjectNode createNode(R bean,
		...
		return Jackson.createNode(mapper, bean,
	...
	private static <R> ObjectNode createNode(ObjectMapper mapper, R bean,
		...
		// properties
		ObjectNode rootNode = Jackson.createNodeWithSimpleFields(mapper, bean,
				simpleFields);
				...
				if ((nestedBean.getClass().isArray()) || (Collection.class
					...
					if (array.length > 0) {
						...
						for (Object object : array) {
							ObjectNode nestedNode = Jackson.createNode(mapper,
